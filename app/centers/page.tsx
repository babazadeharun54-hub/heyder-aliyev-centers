        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="grid gap-10 py-16 lg:grid-cols-[1fr_420px] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <div className="rounded-2xl bg-white/10 px-6 py-4">
                  ...
                  <p className="mt-1 font-extrabold">{center.city}</p>
                </div>

                <div className="rounded-2xl bg-white/10 px-6 py-4">
                  <p className="text-sm text-white/50">Ünvan</p>
                  <p className="mt-1 font-extrabold">{center.address}</p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to top, rgba(0,0,0,.65), rgba(0,0,0,.1)), url('/hero.jpg')",
              }}
            />
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          >
            ...
            <p className="mt-2 text-slate-500">
              Formu doldurun. Məlumatlar seçilmiş tədbir və mərkəz adı ilə
              sistemə yazılacaq.
            </p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <select
                ...
                className="rounded-2xl border border-slate-200 px-5 py-4 outline-none transition focus:border-blue-500 md:col-span-2"
              >
